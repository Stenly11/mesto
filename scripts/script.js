...
function createCard(card) {
  ...
  const buttonDeletCard = document.querySelector(".card__image-delet-button");
  buttonDeletCard.addEventListener("click", deletingCard);
...
formAddNewCard.addEventListener("submit", formSubmitHandlerImg);
